...
<body>
	...
	<div class="xiangqing_div1">
		<p class="xiangqing_div1_p1">订单状态：交易已成功</p>
		<p class="xiangqing_div1_p2">
			1.交易成功，请给爱体验网<a href="#">评价</a>
		</p>
		<p class="xiangqing_div1_p3">2.如果没有收到货，或收到货后出现问题，您可以联系爱体验网官方客服协商解决。</p>
		<p class="xiangqing_div1_p4">
			3.如果爱体验网没有履行应尽的承诺，您可以“<a class="wancheng" href="#">投诉维护</a>”
		</p>
		...
		<img class="xiangqing_div1_img1" src="../images/pc/050.gif" />
	</div>
	<div class="xiangqing_div2">
		...
		<div class="xiangqing_div2_div3">
			...
			<p class="xiangqing_div2_div3_p5">
				<span>成交时间</span> - <span><fmt:formatDate
						value="${trade.finishTime}" pattern="yyyy-MM-dd:HH:mm" /></span>
			</p>
		</div>
	</div>
