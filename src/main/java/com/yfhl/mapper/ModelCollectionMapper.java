...
public interface ModelCollectionMapper {
	...
	int insert(ModelCollection record);

	ModelCollection selectByPrimaryKey(Integer mcId);

	int updateByPrimaryKeySelective(ModelCollection record);

	int updateByPrimaryKey(ModelCollection record);
