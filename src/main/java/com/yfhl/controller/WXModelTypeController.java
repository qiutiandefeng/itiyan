 ...
 */
@Controller
@RequestMapping("wxModelTypeController")
public class WXModelTypeController {
	 ...
	 * @auther luans
	 */
	@RequestMapping("wxQueryModelTypeByself")
	@ResponseBody
	public ModelType wxQueryModelTypeByself(ModelType modelType) {
